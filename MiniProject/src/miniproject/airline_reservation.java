...
/*switch case options
Registration, Login, Booking(ask for from and to locations, number of passengers give the fare output),
are you sure you want book Yes if no revert back to booking then booked, Show ticket, Delete reservation, exit) 
*/
class Register {
